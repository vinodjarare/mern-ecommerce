...
const Hero = () => {
  return (
    <section className="bg-white mt-3">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 place-content-center place-items-center ">
        <div className="mr-auto place-self-center lg:col-span-7 col-span-2">
        ...
        <div className="mt-6 lg:mt-0 lg:col-span-5 lg:flex  col-span-2">
          <img
